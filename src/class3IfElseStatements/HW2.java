...
public class HW2 {
   ...
   if temperature is below 32 then it should print “Water will freeze with temperature ”, otherwise “Water will NOT
   freeze with temperature ”. */
        ...
        if (temperature<32) {
            ...
            System.out.println("Water will NOT freeze with temperature.HW");
        }
    }
}
